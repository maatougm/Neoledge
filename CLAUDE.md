...
# E2E (Playwright — golden flows: login, projects, questionnaire, cahier stream, assign, notifications)
...
# Gated pgvector integration tests (real pg16+vector)
cd web/back-nest && INTEGRATION_DB_URL=postgresql://... npx jest src/ai/embeddings/pgvector.int
```
